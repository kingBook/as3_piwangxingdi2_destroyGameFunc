package g {
	...
	public class MapData {
		...
		public static function getMapConfigObj(gameLevel:int):* {
			...
			arr[15]={size:{ width:800, height:600 }, wall: { name: "Wall_mc", frame: 15 }, hit: { name: "Hit_mc", frame: 15}, items: { name: "_Items15", frame: 1}, bg: { name: "Bg_mc", frame: 15}, bgMid: {name: "BgMid_mc", frame: 15}, bgEff: { name:"BgEff_mc", frame:15}, wallEff: { name: "WallEff_mc", frame:15}, wallMask: { name:"WallMask_mc", frame:15}};
			
			arr[16]={size:{ width:800, height:600 }, wall: { name: "Wall_mc", frame: 16 }, hit: { name: "Hit_mc", frame: 16}, items: { name: "_Items16", frame: 1}, bg: { name: "Bg_mc", frame: 16}, bgMid: {name: "BgMid_mc", frame: 16}, bgEff: { name:"BgEff_mc", frame:16}, wallEff: { name: "WallEff_mc", frame:16}, wallMask: { name:"WallMask_mc", frame:16}};
			arr[17]={size:{ width:800, height:600 }, wall: { name: "Wall_mc", frame: 17 }, hit: { name: "Hit_mc", frame: 17}, items: { name: "_Items17", frame: 1}, bg: { name: "Bg_mc", frame: 17}, bgMid: {name: "BgMid_mc", frame: 17}, bgEff: { name:"BgEff_mc", frame:17}, wallEff: { name: "WallEff_mc", frame:17}, wallMask: { name:"WallMask_mc", frame:17}};
			arr[18]={size:{ width:800, height:600 }, wall: { name: "Wall_mc", frame: 18 }, hit: { name: "Hit_mc", frame: 18}, items: { name: "_Items18", frame: 1}, bg: { name: "Bg_mc", frame: 18}, bgMid: {name: "BgMid_mc", frame: 18}, bgEff: { name:"BgEff_mc", frame:18}, wallEff: { name: "WallEff_mc", frame:18}, wallMask: { name:"WallMask_mc", frame:18}};
			arr[19]={size:{ width:800, height:600 }, wall: { name: "Wall_mc", frame: 19 }, hit: { name: "Hit_mc", frame: 19}, items: { name: "_Items19", frame: 1}, bg: { name: "Bg_mc", frame: 19}, bgMid: {name: "BgMid_mc", frame: 19}, bgEff: { name:"BgEff_mc", frame:19}, wallEff: { name: "WallEff_mc", frame:19}, wallMask: { name:"WallMask_mc", frame:19}};
			arr[20]={size:{ width:800, height:600 }, wall: { name: "Wall_mc", frame: 20 }, hit: { name: "Hit_mc", frame: 20}, items: { name: "_Items20", frame: 1}, bg: { name: "Bg_mc", frame: 20}, bgMid: {name: "BgMid_mc", frame: 20}, bgEff: { name:"BgEff_mc", frame:20}, wallEff: { name: "WallEff_mc", frame:20}, wallMask: { name:"WallMask_mc", frame:20}};
